...
class WashingMachine {
    ...
    constructor(){
        ...
        MachineEl.setAttribute("x", this.BasePosition.x);
        ...
        Circle.setAttribute("cx", this.CirclePosition.x);
        ...
        Dial.setAttribute("cx", this.DialPosition.x);
